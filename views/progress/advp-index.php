                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="panel-body">
                                            <div class="slimscroll" data-always-visible="true" data-rail-visible="true"
                                                ...
                                                <table class="table table-striped table-hover table-bordered"
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    foreach ($teacher_std_project as $rows) {
                                                        $student = \app\modules\scholar_b\models\ScbStudentHasProject::find()->where(['project_code' => $rows['project_code']])->all();
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="text-align:center;">
                                                                        ...
                                                                        <a href="../progress/advp-view?seq=<?php echo $seq ?>&proj_year=<?php echo $item->year ?>&proj_sem=<?php echo $item->semester ?>&proj_code=<?php echo $item->project_code ?>&year_select=<?php echo $year_select ?>&sem_select=<?php echo $sem ?>&student_id=<?= $student_id ?>"
                                                                           class="btn btn-xs btn-success white"><i
                                                                                    class="glyphicon glyphicon-list"></i>
                                                                        </a>

                                                                        <a href="../progress/advp-comment?seq=<?php echo $seq ?>&proj_year=<?php echo $item->year ?>&proj_sem=<?php echo $item->semester ?>&proj_code=<?php echo $item->project_code ?>&year_select=<?php echo $year_select ?>&sem_select=<?php echo $sem ?>&student_id=<?= $student_id ?>"
                                        ...
                                        <div align="right">
                                            ...
                                            <a class="btn btn-default btn-xs">
                                                <i class="glyphicon glyphicon-comment"> ลงความเห็น/แก้ไขความเห็น</i>
                                            </a>
                                        </div>
                                        <!-- /panel content -->
                                    </div>
