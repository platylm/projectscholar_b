                                        ...
                                        <div class="panel-body">
                                            <div class="slimscroll" data-always-visible="true" data-rail-visible="true"
                                                ...
                                                <table class="table table-striped table-hover table-bordered"
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    foreach ($project_student as $rows) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div style="text-align:center;">
                                                                            ...
                                                                            <a href="../progress/stf-view-result?seq=<?php echo $seq ?>&proj_year=<?php echo $item->year ?>&proj_sem=<?php echo $item->semester ?>&proj_code=<?php echo $item->project_code ?>&year_select=<?php echo $year_select ?>&sem_select=<?php echo $sem ?>&student_id=<?= $student_id ?>"
                                                                               class="btn btn-xs btn-success white"><i
                                                                                    class="glyphicon glyphicon-list"></i>
                                                                            </a>

                                                                            <a href="../progress/stf-view-comment?seq=<?php echo $seq ?>&proj_year=<?php echo $item->year ?>&proj_sem=<?php echo $item->semester ?>&proj_code=<?php echo $item->project_code ?>&year_select=<?php echo $year_select ?>&sem_select=<?php echo $sem ?>&student_id=<?= $student_id ?>"
                                        ...
                                        <div align="right">
                                            ...
                                            <a class="btn btn-default btn-xs">
                                                <i class="glyphicon glyphicon-comment">
                                                    ดูความคิดเห็นจากอาจารย์ที่ปรึกษาโครงงาน</i>
                                            </a>
                                        </div>
                                        <!-- /panel content -->
                                    </div>
