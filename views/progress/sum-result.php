...
<div id="content" class="padding-20">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="alert alert-bordered-dashed margin-bottom-30" style="height: 290px !important;">
                    <!-- DASHED --></span>
            ...
            <div class="col-md-6">
                <div class="alert alert-bordered-dashed margin-bottom-30" style="height: 290px !important;">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <center><h5><strong>สรุปผลการประเมินโดยรวม</strong></h5></center>
                            <?= $form->field($progress_find, 'sum_result')->radio(['label' => 'ผ่าน', 'value' => 1, 'uncheck' => null]) ?>
                            <?= $form->field($progress_find, 'sum_result')->radio(['label' => 'ไม่ผ่าน', 'value' => 0, 'uncheck' => null]) ?>
                        </div>
                        <div class="row">
                            <center><h5><strong>แจ้งสถานะในทุนการศึกษา</strong></h5></center>
                            <?= $form->field($student, 'out_of_scb_status')->radio(['label' => 'อยู่ในทุนต่อ', 'value' => 0, 'uncheck' => null]) ?>
                            <?= $form->field($student, 'out_of_scb_status')->radio(['label' => 'หลุดทุน', 'value' => 1, 'uncheck' => null]) ?>
                        </div>
                    </div>
                </div>
            </div>
