            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <span>
                            <i class="fa fa-tag"></i>
                            รายชื่อนักศึกษาที่ยื่นนำเสนอความก้าวหน้า
                            </a>
                        </span>
                        </div>
                                ...
                                <div class="tabs nomargin">
                                        ...
                                        foreach ($student_progress as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php $data = ScbStudent::find()->where(['student_id' => $item['student_id']])->one();
                                                    ...
                                                    ?></td>
                                                <td>
                                                    <a href="../progress/cmt-index?student_id=<?= $item['student_id'] ?>&seq=<?= $seq ?>&sem=<?= $sem ?>&year_select=<?= $year_select ?>"
                                                       class="btn btn-info btn-xs">
                                                        <i class="fa fa-eye"></i>
                                                    </a>

                                                    <a href="../progress/view-sum-result?student_id=<?= $item['student_id'] ?>&seq=<?= $seq ?>&sem=<?= $sem ?>&year_select=<?= $year_select ?>"
                                    ...
                                    <div align="right">
                                        ...
                                        <a class="btn btn-warning btn-xs">
                                            <i class="fa fa-legal"></i> สรุปผลการประเมิน
                                        </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <span>
                            <i class="fa fa-tag"></i>
                            รายชื่อนักศึกษาที่ยังไม่ยื่นนำเสนอความก้าวหน้า
                            </a>
                        </span>
                        </div>
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="panel-body">
                                <div class="tabs nomargin">
                                    <table class="table table-bordered table-striped table-scb">
                                        ...
                                        foreach ($student_all as $item) {
                                            foreach ($student_progress as $row) {
