                                        ...
                                        foreach ($student_progress as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php $data = ScbStudent::find()->where(['student_id' => $item['student_id']])->one();
                                                    ...
                                                    ?></td>
                                                <td>
                                                    <a href="../progress/stf-index?student_id=<?= $item['student_id'] ?>&seq=<?= $seq ?>&sem=<?= $sem ?>&year_select=<?= $year_select ?>"
                                                       class="btn btn-info btn-xs">
                                                        <i class="fa fa-eye"></i>
                                                    </a>

                                                    <a href="../progress/sum-result?student_id=<?= $item['student_id'] ?>&seq=<?= $seq ?>&sem=<?= $sem ?>&year_select=<?= $year_select ?>"
