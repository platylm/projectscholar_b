...
use dixonsatit\thaiYearFormatter;
...
<?php $form = ActiveForm::begin([
    ...
    <input type="hidden" name="year_select" value="<?= $year_select ?>">
    ...
    <div class="scb-progress-report-select">
                    ...
                    <div class="col-md-12">
                        <div class="tabs nomargin">
                            ...
                            <div class="tab-content transparent">
                                ...
                                <!-- Start TAB1 -->
                                <div id="jtab1_nobg" class="tab-pane">
                                    <div class="panel-heading">
                                ...
                                <div id="jtab2_nobg" class="tab-pane active">
                                    ...
                                    <div class="form-group">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div style="text-align:center;">
                                                                            ...
                                                                            <a href="../progress/cmt-view-result?seq=<?php echo $seq ?>&proj_year=<?php echo $item->year ?>&proj_sem=<?php echo $item->semester ?>&proj_code=<?php echo $item->project_code ?>&year_select=<?php echo $year_select ?>&sem_select=<?php echo $sem ?>&student_id=<?= $student_id ?>"
                                                                               class="btn btn-xs btn-success white"><i
                                                                                        class="glyphicon glyphicon-list"></i>
                                                                            </a>

                                                                            <a href="../progress/cmt-view-comment?seq=<?php echo $seq ?>&proj_year=<?php echo $item->year ?>&proj_sem=<?php echo $item->semester ?>&proj_code=<?php echo $item->project_code ?>&year_select=<?php echo $year_select ?>&sem_select=<?php echo $sem ?>&student_id=<?= $student_id ?>"
                                        ...
                                        <div align="right">
                                            <a class="btn btn-info btn-xs">
                                                <i class="fa fa-eye"> ดูรายละเอียดโครงงาน</i>
                                            </a>
                                            <a class="btn btn-xs btn-success white">
                                                <i class="glyphicon glyphicon-list"> ดูรายงานผลโครงงาน</i>
                                            </a>
                                            <a class="btn btn-default btn-xs">
                                                <i class="glyphicon glyphicon-comment">
                                                    ดูความความเห็นอาจารย์ที่ปรึกษาโครงงาน</i>
                                            </a>
                                        </div>
                                        <!-- /panel content -->
                                    </div>
        ...
        <div id="content" class="padding-20">
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-bordered-dashed margin-bottom-30"><!-- DASHED --></span>
                            <center><h5><strong>ส่วนกรรมการพัฒนานักศึกษาเพื่อการแข่งขันภาควิชาลงความคิดเห็น</strong>
                                </h5></center>
                            <?= $form->field($progress_comment, 'comment')->widget(CKEditor::className(), [
                                'options' => ['rows' => 3],
                                'preset' => 'basic',
                            ])->label('กรรมการลงความคิดเห็นเกี่ยวกับการรายงานความก้าวหน้าในครั้งนี้') ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="alert alert-bordered-dashed margin-bottom-30" style="height: 170px !important;">
                            <!-- DASHED --></span>
                            <center><h5><strong>ผลการพิจารณา</strong></h5></center>
                            <?= $form->field($progress_comment, 'result')->radio(['label' => 'ผ่าน', 'value' => 1, 'uncheck' => null]) ?>
                            <?= $form->field($progress_comment, 'result')->radio(['label' => 'ไม่ผ่าน', 'value' => 0, 'uncheck' => null]) ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="alert alert-bordered-dashed margin-bottom-30 " style="height: 170px !important;">
                            ...
                            <p>
                            <center><h5><?php if ($progress_comment->udtime)
                                        echo "( " . Yii::$app->thaiFormatter->asDate($progress_comment->udtime, 'short') . " )"; ?></h5>
                            </center>
                            </p>
                        </div>
                    </div>
