...
<header id="page-header">
    <h1>สมัครเข้าร่วมโครงการผู้มีความสามารถดีเด่น</h1>
    <ol class="breadcrumb">
        <li><a href="#">สมัครทุน</a></li>
        <li class="active">สมัครเข้าร่วมโครงการผู้มีความสามารถดีเด่น</li>
    </ol>
</header>
                    ...
                    <div style="margin: 0 100px">
                        <header>
                            ...
                            <h4><strong>
                                    ...
                                    <center>
                                        แบบฟอร์มสมัครเข้าร่วมโครงการส่งเสริมการผลิตบัณฑิตที่มีความสามารถพิเศษทางคอมพิวเตอร์และเทคโนโลยีสารสนเทศ
                        ...
                        <div class="wizard-inner">
                            ...
                            <span class="round-tab">
                                ...
                                <li role="presentation" class="disabled">
                                    <a href="#step4" data-toggle="tab" aria-controls="step4" role="tab"
                                       title="เลือกสาขาวิชาและอัพโหลดเอกสาร">
                            <span class="round-tab">
                                <i class="glyphicon glyphicon-briefcase"></i>
                            </span>
                                    </a>
                                    <button href="#step4" data-toggle="tab" aria-controls="step4" class="cs-hidded" ></button>
                                </li>
                            ...
                            <span class="round-tab">
                                <i class="glyphicon glyphicon-ok"></i>
                                    ...
                                    <button href="#step5" data-toggle="tab" aria-controls="step5" class="cs-hidded" ></button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step4">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4">
                                                <label>สาขาวิชาที่เลือก</label>
                                                <select name="contact[prefix]"
                                                        class="form-control pointer required">
                                                    <option value="">สาขาวิชาที่เลือก</option>
                                                    <option value="1">สาขาวิชาวิทยาการคอมพิวเตอร์</option>
                                                    <option value="2">สาขาวิชาเทคโนโลยีสารสนเทศและการสื่อสาร
                                                    </option>
                                                    <option value="3">สาขาวิชาภูมิสารสนเทศศาสตร์</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4">
                                                <label>สำรองอันดับ 1</label>
                                                <select name="contact[prefix]"
                                                        class="form-control pointer required">
                                                    <option value="">สำรองอันดับ 1</option>
                                                    <option value="1">สาขาวิชาวิทยาการคอมพิวเตอร์</option>
                                                    <option value="2">สาขาวิชาเทคโนโลยีสารสนเทศและการสื่อสาร
                                                    </option>
                                                    <option value="3">สาขาวิชาภูมิสารสนเทศศาสตร์</option>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4">
                                                <label>สำรองอันดับ 2</label>
                                                <select name="contact[prefix]"
                                                        class="form-control pointer required">
                                                    <option value="">สำรองอันดับ 2</option>
                                                    <option value="1">สาขาวิชาวิทยาการคอมพิวเตอร์</option>
                                                    <option value="2">สาขาวิชาเทคโนโลยีสารสนเทศและการสื่อสาร
                                                    </option>
                                                    <option value="3">สาขาวิชาภูมิสารสนเทศศาสตร์</option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6">
                                                <label>อัพโหลดหลักฐาน โดยเป็นไฟล์ ZIP<br>1.ใบสมัครสอบ<br>2.สำเนา
                                                    รบ.1-ป
                                                    (รับรองสำเนา)<br>3.สำเนาแสดงผลการเรียน
                                                    ชั้นมัธยมศึกษาปีที่
                                                    4-5
                                                    (ปพ.1)
                                                    (รับรองสำเนา)<br>4.สำเนาทะเบียนบ้านของนักเรียน
                                                    (รับรองสำเนา)<br>5.สำเนาทะเบียนบ้านของบิดามารดา
                                                    / ผู้ปกครอง
                                                    (รับรองสำเนา)<br>6.เอกสารคำรับรองของผู้บริหารโรงเรียน</label>
                                                <div class="fancy-file-upload fancy-file-success">
                                                    <i class="fa fa-upload"></i>
                                                    <input type="file" class="form-control"
                                                           name="contact[attachment]"
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="form-inline">
                                                    <label>ผลงานที่ได้รับรางวัล</label><br>
                                                    <input type="text" name="port_name1" class="form-control"
                                                           placeholder="ชื่อผลงานที่ได้รับรางวัล"
                                                           style="width: 250px;">
                                                    <select style="width: 250px;" name="port_level1">
                                                        <option value="">เลือกระดับ</option>
                                                        <option value="">ระดับประเทศ</option>
                                                        <option value="">ระดับภาค</option>
                                                        <option value="">ระดับจังหวัด</option>
                                                    </select>
                                                    <input type="text" name="port_date1" value=""
                                                           class="form-control datepicker"
                                                           data-format="yyyy-mm-dd"
                                                           data-lang="en" data-RTL="false"
                                                           placeholder="วันที่แข่งขัน"
                                                           style="width: 250px;">
                                                    <div id="gpaInput1"></div>
                                                    <input type="button" id="addInput1"
                                                           value="+ เพิ่มผลงานที่ได้รับรางวัล"
                                                           class="btn btn-warning">
                                                </div>
                                                <br>
                                                <!-- custom file upload -->
                                                <div class="fancy-file-upload fancy-file-success form-group">
                                                    <i class="fa fa-upload"></i>
                                                    <input type="file" class="form-control"
                                                           name="contact[attachment]"
                                                           onchange="jQuery(this).next('input').val(this.value);"
                                                    ...
                                                    <input type="text" class="form-control"
                                                           placeholder="no file selected (.zip)" readonly=""/>
                                                    <span class="button">เลือกไฟล์ </span>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="form-inline">
                                                    <label>ผลงานที่เข้าร่วมการแข่งขัน</label><br>
                                                    <div class="form-group">
                                                        <input type="text" name="port_name1"
                                                               class="form-control"
                                                               placeholder="ชื่อผลงานที่เข้าร่วมแข่งขัน"
                                                               style="width: 250px;">
                                                    </div>
                                                    <div class="form-group">
                                                        <select style="width: 250px;" name="port_level1">
                                                    ...
                                                    <div class="form-group" id="gpaInput2">
                                                        <input type="text" name="port_date1" value=""
                                                               class="form-control datepicker"
                                                               data-format="yyyy-mm-dd"
                                                               data-lang="en" data-RTL="false"
                                                    ...
                                                    <div id="gpaInput2"></div>
                                                    <input type="button" id="addInput2"
                                                           value="+ เพิ่มผลงานที่เข้าร่วมแข่งขัน"
                                                           class="btn btn-warning">
                                                </div>
                                                <br>
                                                <!-- custom file upload -->
                                                <div class="fancy-file-upload fancy-file-success form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           placeholder="no file selected (.zip)"
                                                           readonly=""/>
                                                    <span class="button">เลือกไฟล์ </span>
                                    ...
                                    <ul class="list-inline pull-right">
                                        ...
                                        <li>
                                            <button type="button" name="show" onclick="nextpage(5)"
                                                    class="btn btn-success next-step">ถัดไป
                                            </button>
                                        </li>
                                    </ul>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step5">
                                    <h4>สมัครทุนเรียบร้อย</h4>
                                    <a href="../student/index_other" class="text-center new-account">กลับสู่หน้าหลัก </a>
                                </div>
