                                    ...
                                    <div class="tab-content transparent">
                                        ...
                                        <div id="jtab1_nobg" class="tab-pane active"><!-- TAB 1 CONTENT -->
                                            <div class="row">
                                                <div class="col-sm-9">
                                                    <?php $form = ActiveForm::begin([
                                                        'class' => 'horizontal',
                                                        'method' => 'get',
                                                        'action'=>'info-student-all'
                                                    ]); ?>
                                                    <?php

                                                    echo Select2::widget([
                                                        'name' => 'scholarship_name',
                                                        'value' => $sholarship_search,
                                            ...
                                            <div class="row">
                                                    ...
                                                    <?= Html::button('<i class="fa fa-download"></i>' . controllers::t('label', 'Download'), ['class' => 'btn btn-primary','onclick'=>'download()']) ?>
...
<script>function download() {
    $.ajax({
      ...
      type: 'get',
      data: {
        scholarship_search: '<?=$sholarship_search?>',
