...
<header id="page-header">
    <h1><?= controllers::t('label', 'Edit Event') ?></h1>
    <ol class="breadcrumb">
        <li><a href="../site/index"><?= controllers::t('label', 'Home') ?></a></li>
        <li class=""><a href="../calendar/index"><?= controllers::t('label', 'Event') ?></a></li>
        <li class="active"><?= controllers::t('label', 'Edit Event') ?></li>
    </ol>
</header>
<!-- /page title -->
<div class="scb-calendar-update">
                ...
                <div class="panel-body">
                    <div class="container">
                        ...
                        <?php $form = ActiveForm::begin([
                            'action' => '../calendar/update?id='.$model->calendar_id,
                            'method' => 'post',
                        ]); ?>
