            ...
            <ul class="nav nav-list menubox">
                ...
                <li><!-- Demo -->
                    <?= Html::a("<i class=\"main-icon fa fa-home\"></i> <span>หน้าหลัก</span>",
                        ['site/index-other'], ['class' => 'main']) ?>
                </li>
                <li>
                    <?= Html::a("<i class=\"main-icon fa fa-user-plus\"></i> <span>สมัครสมาชิก</span>",
                        ['candidate/create']) ?>
                </li>
                <li>
                    <?= Html::a("<i class=\"main-icon fa fa-refresh\"></i> <span>ลืมรหัสผ่าน</span>",
                        ['candidate/forgot-password']) ?>
                </li>
                <li>
                    <?= Html::a("<i class=\"main-icon fa fa-lock\"></i><span>เข้าสู่ระบบ</span>",
                        ['login/login']) ?>
                </li>
            </ul>
            ...
            <ul class="nav pull-right menubox">
                ...
                <li class="dropdown pull-left">
                       ...
                       data-close-others="true">
                        ...
                        <span class="user-name">
									<span class="hidden-xs">
                                        ยังไม่เข้าสู่ระบบ<i class="fa fa-angle-down"></i>
                    ...
                    <ul class="dropdown-menu hold-on-click">
                        <li><!-- Login -->
                            <a href="../login/login"><i class="fa fa-user"></i> เข้าสู่ระบบ</a>
                        </li>
                    </ul>
                </li>
                <!-- /USER OPTIONS -->
